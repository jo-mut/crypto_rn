(ns main.constants.dummy)

(def portfolio
  {:balance "12724.33"
   :changes "+2.36%"})

(def trending-currencies
  [{:id 1
    :currency "Bitcoin"
    :code "BTC"
    :image (js/require "../assets/images/bitcoin.png")
    :amount "29455.74"
    :changes "+7.24%"
   ...
   {:id 2
    :currency "Ethereum"
    :code "ETH"
    :image (js/require "../assets/images/ethereum.png")
    :amount "919.03"
    :changes "-0.73%"
    :ype "D"
   ...
   {:id 3
    :currency "Litecoin"
    :code "LTC"
    :image (js/require "../assets/images/litecoin.png")
    :amount "118.33"
    :changes "+1.73%"
    :type "I"
   ...
   {:id          4
    :currency    "Ripple"
    :code        ":xRP"
    :image       (js/require "../assets/images/ripple.png")
    :amount      "0.24"
    :changes     "-0.51%"
    :type        "D"
    :description "Ripple is a real-time gross settlement system currency e:xchange and remittance network created by Ripple Labs Inc. a US-based technology company."
    :chartData   [{:x 1 :y 2.3}
                  {:x 1.5 :y 2.3}
                  {:x 2 :y 2.5}
                  {:x 2.5 :y 2.1}
