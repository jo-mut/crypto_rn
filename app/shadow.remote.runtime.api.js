...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_21168 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_21168(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_21175 = (function (runtime,key,spec){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_21175(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_21176 = (function (runtime,key){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_21176(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_21177 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_21177(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_21180 = (function (runtime,input,callback){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_21180(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_21186 = (function (runtime,code){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_21186(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__21158,callback){
var map__21160 = p__21158;
var map__21160__$1 = cljs.core.__destructure_map(map__21160);
var input = map__21160__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21160__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21160__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
