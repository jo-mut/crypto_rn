...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_12636 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_12636(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_12647 = (function (runtime,key,spec){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_12647(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_12654 = (function (runtime,key){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_12654(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_12668 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_12668(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_12688 = (function (runtime,input,callback){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_12688(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_12700 = (function (runtime,code){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_12700(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__12581,callback){
var map__12584 = p__12581;
var map__12584__$1 = cljs.core.__destructure_map(map__12584);
var input = map__12584__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12584__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12584__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
