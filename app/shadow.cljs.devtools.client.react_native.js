...
var seq__21176 = cljs.core.seq(sources);
var chunk__21177 = null;
var count__21178 = (0);
var i__21179 = (0);
while(true){
if((i__21179 < count__21178)){
var map__21182 = chunk__21177.cljs$core$IIndexed$_nth$arity$2(null, i__21179);
var map__21182__$1 = cljs.core.__destructure_map(map__21182);
var src = map__21182__$1;
var resource_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21182__$1,new cljs.core.Keyword(null,"resource-name","resource-name",2001617100));
var js = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21182__$1,new cljs.core.Keyword(null,"js","js",1768080579));
...
var G__21212 = seq__21176;
var G__21213 = chunk__21177;
var G__21214 = count__21178;
var G__21215 = (i__21179 + (1));
seq__21176 = G__21212;
chunk__21177 = G__21213;
count__21178 = G__21214;
i__21179 = G__21215;
continue;
} else {
var temp__5804__auto__ = cljs.core.seq(seq__21176);
if(temp__5804__auto__){
var seq__21176__$1 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__21176__$1)){
var c__5525__auto__ = cljs.core.chunk_first(seq__21176__$1);
var G__21216 = cljs.core.chunk_rest(seq__21176__$1);
var G__21217 = c__5525__auto__;
var G__21218 = cljs.core.count(c__5525__auto__);
var G__21219 = (0);
seq__21176 = G__21216;
chunk__21177 = G__21217;
count__21178 = G__21218;
i__21179 = G__21219;
continue;
} else {
var map__21183 = cljs.core.first(seq__21176__$1);
var map__21183__$1 = cljs.core.__destructure_map(map__21183);
var src = map__21183__$1;
var resource_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21183__$1,new cljs.core.Keyword(null,"resource-name","resource-name",2001617100));
var js = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21183__$1,new cljs.core.Keyword(null,"js","js",1768080579));
shadow.cljs.devtools.client.react_native.devtools_msg.cljs$core$IFn$_invoke$arity$2("load JS",resource_name);
...
var G__21220 = cljs.core.next(seq__21176__$1);
var G__21221 = null;
var G__21222 = (0);
var G__21223 = (0);
seq__21176 = G__21220;
chunk__21177 = G__21221;
count__21178 = G__21222;
i__21179 = G__21223;
continue;
}
} else {
...
/** @this {Function} */
(shadow.cljs.devtools.client.react_native.noop.cljs$lang$applyTo = (function (seq21184){
var self__5712__auto__ = this;
return self__5712__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq21184));
}));

shadow.cljs.devtools.client.react_native.handle_build_complete = (function shadow$cljs$devtools$client$react_native$handle_build_complete(runtime,p__21186){
var map__21187 = p__21186;
var map__21187__$1 = cljs.core.__destructure_map(map__21187);
var msg = map__21187__$1;
var info = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21187__$1,new cljs.core.Keyword(null,"info","info",-317069002));
var reload_info = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21187__$1,new cljs.core.Keyword(null,"reload-info","reload-info",1648088086));
var map__21188 = info;
var map__21188__$1 = cljs.core.__destructure_map(map__21188);
var sources = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21188__$1,new cljs.core.Keyword(null,"sources","sources",-321166424));
var compiled = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21188__$1,new cljs.core.Keyword(null,"compiled","compiled",850043082));
var warnings = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21188__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
...
return shadow.cljs.devtools.client.shared.load_sources(runtime,sources_to_get,(function (p1__21185_SHARP_){
return shadow.cljs.devtools.client.react_native.do_js_reload(msg,p1__21185_SHARP_,shadow.cljs.devtools.client.react_native.noop);
}));
} else {
return null;
}
...
shadow.cljs.devtools.client.react_native.attempt_to_find_host = (function shadow$cljs$devtools$client$react_native$attempt_to_find_host(start_fn,p__21189){
...
var host = first__21192;
var more_hosts = seq__21191__$1;
...
(shadow.cljs.devtools.client.shared.Runtime.prototype.shadow$cljs$devtools$client$shared$IHostSpecific$do_invoke$arity$3 = (function (this$,ns,p__21193){
var map__21194 = p__21193;
var map__21194__$1 = cljs.core.__destructure_map(map__21194);
var _ = map__21194__$1;
var js = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21194__$1,new cljs.core.Keyword(null,"js","js",1768080579));
var this$__$1 = this;
return shadow.cljs.devtools.client.react_native.global_eval(js);
}));

(shadow.cljs.devtools.client.shared.Runtime.prototype.shadow$cljs$devtools$client$shared$IHostSpecific$do_repl_init$arity$4 = (function (runtime,p__21195,done,error){
var map__21196 = p__21195;
var map__21196__$1 = cljs.core.__destructure_map(map__21196);
var repl_sources = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21196__$1,new cljs.core.Keyword(null,"repl-sources","repl-sources",723867535));
...
(shadow.cljs.devtools.client.shared.Runtime.prototype.shadow$cljs$devtools$client$shared$IHostSpecific$do_repl_require$arity$4 = (function (runtime,p__21197,done,error){
var map__21198 = p__21197;
var map__21198__$1 = cljs.core.__destructure_map(map__21198);
var msg = map__21198__$1;
var sources = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21198__$1,new cljs.core.Keyword(null,"sources","sources",-321166424));
var reload_namespaces = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21198__$1,new cljs.core.Keyword(null,"reload-namespaces","reload-namespaces",250210134));
var js_requires = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21198__$1,new cljs.core.Keyword(null,"js-requires","js-requires",-1311472051));
var runtime__$1 = this;
var sources_to_load = cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p__21199){
var map__21200 = p__21199;
var map__21200__$1 = cljs.core.__destructure_map(map__21200);
var src = map__21200__$1;
var provides = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21200__$1,new cljs.core.Keyword(null,"provides","provides",-1634397992));
...
var G__21201 = cljs.core.PersistentVector.EMPTY;
return (done.cljs$core$IFn$_invoke$arity$1 ? done.cljs$core$IFn$_invoke$arity$1(G__21201) : done.call(null, G__21201));
} else {
return shadow.remote.runtime.shared.call.cljs$core$IFn$_invoke$arity$3(runtime__$1,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"op","op",-1882987955),new cljs.core.Keyword(null,"cljs-load-sources","cljs-load-sources",-1458295962),new cljs.core.Keyword(null,"to","to",192099007),shadow.cljs.devtools.client.env.worker_client_id,new cljs.core.Keyword(null,"sources","sources",-321166424),cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"resource-id","resource-id",-1308422582)),sources_to_load)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"cljs-sources","cljs-sources",31121610),(function (p__21202){
var map__21203 = p__21202;
var map__21203__$1 = cljs.core.__destructure_map(map__21203);
var msg__$1 = map__21203__$1;
var sources__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21203__$1,new cljs.core.Keyword(null,"sources","sources",-321166424));
try{shadow.cljs.devtools.client.react_native.do_js_load(sources__$1);

return (done.cljs$core$IFn$_invoke$arity$1 ? done.cljs$core$IFn$_invoke$arity$1(sources_to_load) : done.call(null, sources_to_load));
}catch (e21204){var ex = e21204;
return (error.cljs$core$IFn$_invoke$arity$1 ? error.cljs$core$IFn$_invoke$arity$1(ex) : error.call(null, ex));
}})], null));
}
}));

shadow.cljs.devtools.client.shared.add_plugin_BANG_(new cljs.core.Keyword("shadow.cljs.devtools.client.react-native","client","shadow.cljs.devtools.client.react-native/client",838790877),cljs.core.PersistentHashSet.EMPTY,(function (p__21205){
var map__21206 = p__21205;
var map__21206__$1 = cljs.core.__destructure_map(map__21206);
var env = map__21206__$1;
var runtime = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21206__$1,new cljs.core.Keyword(null,"runtime","runtime",-1331573996));
...
}),new cljs.core.Keyword("shadow.cljs.devtools.client.env","worker-notify","shadow.cljs.devtools.client.env/worker-notify",-1456820670),(function (p__21207){
var map__21208 = p__21207;
var map__21208__$1 = cljs.core.__destructure_map(map__21208);
var event_op = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21208__$1,new cljs.core.Keyword(null,"event-op","event-op",200358057));
var client_id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21208__$1,new cljs.core.Keyword(null,"client-id","client-id",-464622140));
...
var svc = map__21210__$1;
var runtime = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__21210__$1,new cljs.core.Keyword(null,"runtime","runtime",-1331573996));
