...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_10795 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_10795(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_10808 = (function (port,val,fn1_handler){
var x__5350__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_10808(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_10826 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_10826(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_10827 = (function (chan){
var x__5350__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_10827(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_10830 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_10830(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_10840 = (function (h){
var x__5350__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_10840(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_10851 = (function (h){
var x__5350__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_10851(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_10857 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_10857(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_10871 = (function (b){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_10871(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_10878 = (function (b,itm){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_10878(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_10883 = (function (b){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_10883(b);
}
});
