...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,(function (){var G__9786 = (a.cljs$core$IFn$_invoke$arity$1 ? a.cljs$core$IFn$_invoke$arity$1(k) : a.call(null, k));
var G__9787 = (b.cljs$core$IFn$_invoke$arity$1 ? b.cljs$core$IFn$_invoke$arity$1(k) : b.call(null, k));
return (re_frisk_remote.delta.delta.delta.cljs$core$IFn$_invoke$arity$2 ? re_frisk_remote.delta.delta.delta.cljs$core$IFn$_invoke$arity$2(G__9786,G__9787) : re_frisk_remote.delta.delta.delta.call(null, G__9786,G__9787));
})()], null);
} else {
return null;
}
...
return re_frisk_remote.delta.delta.nullify(cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.filter.cljs$core$IFn$_invoke$arity$2(cljs.core.some_QMARK_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__9788_SHARP_){
return re_frisk_remote.delta.delta.ff(a,b,p1__9788_SHARP_);
}),ks))));
});
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.filter.cljs$core$IFn$_invoke$arity$2(cljs.core.some_QMARK_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__9800){
var vec__9806 = p__9800;
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9806,(0),null);
var a__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9806,(1),null);
var b__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9806,(2),null);
...
re_frisk_remote.delta.delta.apply_set = (function re_frisk_remote$delta$delta$apply_set(a,p__9849){
var vec__9850 = p__9849;
var add = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9850,(0),null);
var remove = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9850,(1),null);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (a__$1,p__9855){
var vec__9856 = p__9855;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9856,(0),null);
var ch = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9856,(1),null);
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(a__$1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [k], null),(function (p1__9854_SHARP_){
return (re_frisk_remote.delta.delta.apply.cljs$core$IFn$_invoke$arity$2 ? re_frisk_remote.delta.delta.apply.cljs$core$IFn$_invoke$arity$2(p1__9854_SHARP_,ch) : re_frisk_remote.delta.delta.apply.call(null, p1__9854_SHARP_,ch));
}));
}),a,changes);
});
re_frisk_remote.delta.delta.apply_vec = (function re_frisk_remote$delta$delta$apply_vec(a,p__9863){
var vec__9865 = p__9863;
var tail = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9865,(0),null);
var changes = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9865,(1),null);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (a__$1,p__9885){
var vec__9887 = p__9885;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9887,(0),null);
var ch = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9887,(1),null);
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(a__$1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [k], null),(function (p1__9881_SHARP_){
return (re_frisk_remote.delta.delta.apply.cljs$core$IFn$_invoke$arity$2 ? re_frisk_remote.delta.delta.apply.cljs$core$IFn$_invoke$arity$2(p1__9881_SHARP_,ch) : re_frisk_remote.delta.delta.apply.call(null, p1__9881_SHARP_,ch));
}));
}),a,changes);
});
re_frisk_remote.delta.delta.apply_map = (function re_frisk_remote$delta$delta$apply_map(a,p__9891){
var vec__9892 = p__9891;
var keys_add = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9892,(0),null);
var keys_remove = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9892,(1),null);
var changes = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9892,(2),null);
var A = a;
...
var G__9899 = cljs.core.first(patch);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__9899)){
return a;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"replace","replace",-786587770),G__9899)){
return cljs.core.second(patch);
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"set","set",304602554),G__9899)){
return re_frisk_remote.delta.delta.apply_set(a,cljs.core.rest(patch));
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"vec","vec",-657847931),G__9899)){
return re_frisk_remote.delta.delta.apply_vec(a,cljs.core.rest(patch));
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"map","map",1371690461),G__9899)){
return re_frisk_remote.delta.delta.apply_map(a,cljs.core.rest(patch));
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__9899)].join('')));
