...
if(cljs.core.seq(m)){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (result,p__9546){
var vec__9549 = p__9546;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9549,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9549,(1),null);
...
var vec__9562 = clojure.data.diff(va,vb);
var a_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9562,(0),null);
var b_STAR_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9562,(1),null);
var ab = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__9562,(2),null);
...
var clojure$data$EqualityPartition$equality_partition$dyn_9701 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_9701(x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_9704 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_9704(a,b);
}
});
...
var fexpr__9682 = (function (){var G__9683 = clojure.data.equality_partition(a);
var G__9683__$1 = (((G__9683 instanceof cljs.core.Keyword))?G__9683.fqn:null);
switch (G__9683__$1) {
case "atom":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__9683__$1)].join('')));

}
})();
return (fexpr__9682.cljs$core$IFn$_invoke$arity$2 ? fexpr__9682.cljs$core$IFn$_invoke$arity$2(a,b) : fexpr__9682.call(null, a,b));
}));
/**
