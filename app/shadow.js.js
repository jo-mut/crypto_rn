...
shadow.js.exportCopy = function(module, other) {
  ...
  var key;
  for (key in other) {
    $jscomp$loop$1680581215$0 = {key$jscomp$108:$jscomp$loop$1680581215$0.key$jscomp$108};
    $jscomp$loop$1680581215$0.key$jscomp$108 = key;
    if ($jscomp$loop$1680581215$0.key$jscomp$108 == "default" || $jscomp$loop$1680581215$0.key$jscomp$108 in exports || $jscomp$loop$1680581215$0.key$jscomp$108 in copy) {
      continue;
    }
    copy[$jscomp$loop$1680581215$0.key$jscomp$108] = {enumerable:true, get:function($jscomp$loop$1680581215$0) {
      return function() {
        return other[$jscomp$loop$1680581215$0.key$jscomp$108];
      };
