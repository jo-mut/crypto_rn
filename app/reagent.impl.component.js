...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__8196 = c;
var G__8196__$1 = (((G__8196 == null))?null:G__8196.prototype);
if((G__8196__$1 == null)){
return null;
} else {
return G__8196__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__8197 = c;
var G__8197__$1 = (((G__8197 == null))?null:G__8197.prototype);
if((G__8197__$1 == null)){
return null;
} else {
return G__8197__$1.render;
}
})() == null)))));
});
...
var or__5002__auto__ = (function (){var G__8205 = c;
var G__8205__$1 = (((G__8205 == null))?null:G__8205.constructor);
if((G__8205__$1 == null)){
return null;
} else {
return G__8205__$1.displayName;
}
})();
...
var G__8206 = c;
var G__8206__$1 = (((G__8206 == null))?null:G__8206.constructor);
if((G__8206__$1 == null)){
return null;
} else {
return G__8206__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__8207 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__8208 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__8208);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__8207);
}});
...
var c = this;
var G__8247_8334 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__8247_8334 == null)){
} else {
reagent.ratom.dispose_BANG_(G__8247_8334);
}
...
var renders_8342 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_8343 = cljs.core.first(cljs.core.vals(renders_8342));
...
if((cljs.core.count(renders_8342) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_8342))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_8343)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_8343], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__8282 = o;
reagent.impl.component.goog$module$goog$object.set(G__8282,cljs.core.name(k),v);
...
return (function() { 
var G__8357__delegate = function (args){
return reagent.impl.protocols.as_element(compiler,cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args));
};
...
while (G__8358__i < G__8358__a.length) {G__8358__a[G__8358__i] = arguments[G__8358__i + 0]; ++G__8358__i;}
  args = new cljs.core.IndexedSeq(G__8358__a,0,null);
} 
...
var _STAR_current_component_STAR__orig_val__8307 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__8308 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__8308);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__8307);
}});
...
var vec__8312 = shadow.js.shim.module$react.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8312,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8312,(1),null);
...
var G__8317 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__8317 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__8317);
}
});
}),[]);
