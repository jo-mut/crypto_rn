...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__12298 = c;
var G__12298__$1 = (((G__12298 == null))?null:G__12298.prototype);
if((G__12298__$1 == null)){
return null;
} else {
return G__12298__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__12303 = c;
var G__12303__$1 = (((G__12303 == null))?null:G__12303.prototype);
if((G__12303__$1 == null)){
return null;
} else {
return G__12303__$1.render;
}
})() == null)))));
});
...
return (function() { 
var G__12438__delegate = function (args){
...
var or__5002__auto__ = (function (){var G__12312 = c;
var G__12312__$1 = (((G__12312 == null))?null:G__12312.constructor);
if((G__12312__$1 == null)){
return null;
} else {
return G__12312__$1.displayName;
}
})();
...
var G__12313 = c;
var G__12313__$1 = (((G__12313 == null))?null:G__12313.constructor);
if((G__12313__$1 == null)){
return null;
} else {
return G__12313__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__12316 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__12317 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__12317);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__12316);
}});
...
var c = this;
var G__12363_12453 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__12363_12453 == null)){
} else {
reagent.ratom.dispose_BANG_(G__12363_12453);
}
...
var renders_12456 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_12457 = cljs.core.first(cljs.core.vals(renders_12456));
...
if((cljs.core.count(renders_12456) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_12456))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_12457)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_12457], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__12399 = o;
reagent.impl.component.goog$module$goog$object.set(G__12399,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__12430 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__12431 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__12431);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__12430);
}});
...
var vec__12432 = shadow.js.shim.module$react.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12432,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12432,(1),null);
...
var G__12435 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__12435 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__12435);
}
});
}),[]);
