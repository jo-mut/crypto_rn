  ...
  goog.net.XhrIo.prototype.send = function(url, opt_method, opt_content, opt_headers) {
    ...
    if (opt_headers) {
      if (Object.getPrototypeOf(opt_headers) === Object.prototype) {
        ...
        var $jscomp$iter$5 = $jscomp.makeIterator(opt_headers.keys());
        var $jscomp$key$m788232720$55$key = $jscomp$iter$5.next();
        for (; !$jscomp$key$m788232720$55$key.done; $jscomp$key$m788232720$55$key = $jscomp$iter$5.next()) {
          var key$jscomp$0 = $jscomp$key$m788232720$55$key.value;
          {
    ...
    var $jscomp$iter$6 = $jscomp.makeIterator(headers);
    var $jscomp$key$m788232720$56$ = $jscomp$iter$6.next();
    for (; !$jscomp$key$m788232720$56$.done; $jscomp$key$m788232720$56$ = $jscomp$iter$6.next()) {
      var $jscomp$destructuring$var33 = $jscomp$key$m788232720$56$.value;
      {
        var $jscomp$destructuring$var34 = $jscomp.makeIterator($jscomp$destructuring$var33);
        var key$jscomp$1 = $jscomp$destructuring$var34.next().value;
