...
var G__8384 = o;
reagent.impl.template.goog$module$goog$object.set(G__8384,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null, v)));
...
while (G__8463__i < G__8463__a.length) {G__8463__a[G__8463__i] = arguments[G__8463__i + 0]; ++G__8463__i;}
  args = new cljs.core.IndexedSeq(G__8463__a,0,null);
} 
...
var G__8385 = o;
reagent.impl.template.goog$module$goog$object.set(G__8385,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__8386 = props;
var G__8386__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__8386,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__8386);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__8386__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__8387 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__8387,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__8387;
}
})(),id_class);
...
var G__8388 = (cljs.core.count(argv) - first_child);
switch (G__8388) {
case (0):
...
var vec__8396 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8396,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8396,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8396,(2),null);
...
var temp__5808__auto___8482 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___8482 == null)){
} else {
var key_8483 = temp__5808__auto___8482;
...
var temp__5808__auto___8487 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___8487 == null)){
} else {
var key_8488 = temp__5808__auto___8487;
(jsprops.key = key_8488);
}
...
var temp__5808__auto___8493 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___8493 == null)){
} else {
var key_8495 = temp__5808__auto___8493;
...
var temp__5808__auto___8513 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___8513 == null)){
} else {
var key_8515 = temp__5808__auto___8513;
(jsprops.key = key_8515);
}
...
var temp__5808__auto___8517 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___8517 == null)){
} else {
var key_8520 = temp__5808__auto___8517;
(jsprops.key = key_8520);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__8409_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__8409_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__8416 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8416,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__8416,(1),null);
...
*/
reagent.impl.template.t_reagent$impl$template8438 = (function (opts,id,fn_to_element,parse_fn,meta8439){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta8439 = meta8439;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template8438.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_8440,meta8439__$1){
var self__ = this;
var _8440__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template8438(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta8439__$1));
}));

(reagent.impl.template.t_reagent$impl$template8438.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_8440){
var self__ = this;
var _8440__$1 = this;
return self__.meta8439;
}));

(reagent.impl.template.t_reagent$impl$template8438.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template8438.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template8438.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template8438.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template8438.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template8438.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta8439","meta8439",-1596188717,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template8438.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template8438.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template8438");

(reagent.impl.template.t_reagent$impl$template8438.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template8438");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template8438.
 */
reagent.impl.template.__GT_t_reagent$impl$template8438 = (function reagent$impl$template$__GT_t_reagent$impl$template8438(opts,id,fn_to_element,parse_fn,meta8439){
return (new reagent.impl.template.t_reagent$impl$template8438(opts,id,fn_to_element,parse_fn,meta8439));
});
...
return (new reagent.impl.template.t_reagent$impl$template8438(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
